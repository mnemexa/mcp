...
const ONBOARDING_MESSAGE = `\u{1F510} Mnemexa setup required

It looks like your API key is not configured yet.

To get started:

1. Open Mnemexa dashboard
   https://app.mnemexa.com
...
5. Add it to your MCP configuration:
   ...
   MNEMEXA_API_KEY=your_api_key_here

Once added, restart your AI tool.

Your AI will then be able to remember, learn, and improve over time.`;

const RATE_LIMIT_MESSAGE = `\u26A0\uFE0F Mnemexa rate limit reached

Please wait a moment and try again.`;

const GENERIC_ERROR_MESSAGE = `Something went wrong while connecting to Mnemexa. Please try again.`;
