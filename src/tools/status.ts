...
const CONNECTED_MESSAGE = `\u2705 Mnemexa connected successfully
...
export const statusTool = {
  name: "brain.status",
  description:
    "Check whether Mnemexa is connected and ready. Shows connection status and available capabilities. Useful for verifying setup.",
  inputSchema: {
