...
export const healthTool = {
  name: "brain.health",
  description:
    "Inspect the health and quality of your Mnemexa workspace memory store. Returns health score, total memory count, and stale memory signals. Use to diagnose memory quality issues.",
  inputSchema: {
